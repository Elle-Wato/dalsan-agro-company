                        ...
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    With over 10 years of experience in software analysis and design, we provide customized recommendations and strategies to help agricultural businesses improve operations, reduce costs, and increase efficiency.
                                </p>
                            </div>
                        </div>
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>We collaborate with your existing tech team to scale existing software applications or design customized software solutions that meet your everyday needs and simplify various processes.</p>
                            </div>
                        </div>
                    </div>
                </div>
