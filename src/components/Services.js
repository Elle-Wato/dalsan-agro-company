        ...
        <div id="services" className="bg-gray-100 py-12">
            <section data-aos="zoom-in-down">
                <div className="my-4 py-4">
                    ...
                    <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-blue-900">We offer a comprehensive range of services designed to meet the diverse needs of farmers & agribusinesses.</h2>
                </div>
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                            <div className="m-2 text-justify text-sm">
                                ...
                                <p className="text-md font-medium">
                                    We specialize in Soil testing, crop consulting and farm management advice to optimize production, as well as Customized recommendations for soil health, fertilization & Pest management.
                                </p>
                            </div>
                        </div>
                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <h3 className="text-3xl text-blue-900 font-bold">Our <span className='font-black'>Leadership</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>
                                    Ahmed Ibrahim, the founder and CEO of Dalsan Agro Solutions is a visionary leader with a deep passion for transforming Somalia's agricultural sector. Under his leadership, the company has grown into a trusted patner for 
                        ...
                        <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                            ...
                            <h3 className="text-3xl text-blue-900 font-bold">Our <span className='font-black'>Infrastructure</span></h3>
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-semibold'>Our organizational structure is designed to ensure efficient operations and excellent customer service. We have a strong team of management officers, supervisors and field staff who work together to
                                    deliver on our promises to farmers and patners.
                                </p>
                            </div>
                        </div>
                    </div>
